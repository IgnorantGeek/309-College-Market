...
public class Const {
    ...
    public static final String URL_STRING_REQ = "http://coms-309-jr-1.misc.iastate.edu";
    ...
    public static final String URL_NEW_ITEM = "http://coms-309-jr-1.misc.iastate.edu:8080/items/all";
}
